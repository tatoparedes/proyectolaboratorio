...
<body>
  ...
  <main>
    <aside class="filtros">
      ...
      <a href="#" id="adminCategoriasBtn" class="btn-especie">Buscar Familia</a>
      <a href="#" id="adminEspeciesBtn" class="btn-especie">Administrar Familia</a>
    </aside>
  ...
  <div id="modalAdminCategorias" class="modal-overlay">
    <div class="modal-content">
      <span class="modal-close-btn" data-modal-id="modalAdminCategorias">&times;</span>
      <h2>Administrar Categorías</h2>
      <div id="listaAdminCategorias" class="admin-list"></div>
    </div>
  </div>

  <div id="modalAdminEspecies" class="modal-overlay">
    <div class="modal-content">
      <span class="modal-close-btn" data-modal-id="modalAdminEspecies">&times;</span>
      <h2>Administrar Tipos de Especie</h2>
      <div style="margin-bottom: 20px;">
        <label for="filtroCategoriaEspecie" style="font-weight: bold; display: block; margin-bottom: 5px;">Filtrar por Categoría:</label>
        <select id="filtroCategoriaEspecie" style="width: 100%; padding: 10px; border: 1.5px solid #ccc; border-radius: 8px; font-size: 15px;">
        </select>
      </div>
      <div id="listaAdminEspecies" class="admin-list"></div>
    </div>
  </div>
